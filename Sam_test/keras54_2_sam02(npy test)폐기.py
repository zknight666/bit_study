...
#1. data 전처리
samdf01_csv=pd.read_csv('C:/study/_data/sam01/삼성전자 주가.csv',encoding='cp949',thousands=',')
amodf01_csv=pd.read_csv('C:/study/_data/sam01/아모레퍼시픽 주가.csv',encoding='cp949', thousands=',')
# samdf02=np.load('C:/study/_data/sam01/samdf02.npy',allow_pickle=True)
# amodf02=np.load('C:/study/_data/sam01/amodf02.npy',allow_pickle=True)

#1.2) 총 data 개수, 컬럼 확인 & 클래스 확인 & Dtype 확인 & 결측치 확인
print(samdf01_csv.npy)
print(amodf01_csv.npy)

print(samdf01_csv.npy.shape) # (1980, 17)
print(amodf01_csv.npy.shape) # (2220, 17)
print(samdf01_csv.npy.info()) # <class 'pandas.core.frame.DataFrame'>, 16개 컬럼, 결측치 존재, dtypes: float64(5), int64(10), object(1) -> 숫자에 , 붙은 컬럼들 전부 다 object 취급함 -> , 삭제 필요 -> 삭제 완료
print(amodf01_csv.npy.info()) # <class 'pandas.core.frame.DataFrame'>, 16개 컬럼, 결측치 존재, dtypes: float64(5), int64(10), object(1)
...
np.save('C:/study/_data/sam01/samdf02.npy',arr=samdf01_csv)
np.save('C:/study/_data/sam01/amodf02.npy',arr=amodf01_csv)
