...
dense_sm1 = LSTM(20, return_sequences=True,activation='relu')(input_sm)
dense_sm2 = Dropout(0.2)(dense_sm1)
dense_sm3 = LSTM(20, activation='relu')(dense_sm2)
dense_sm4 = Dense(50, activation='relu')(dense_sm3)
dense_sm5 = Dropout(0.2)(dense_sm4)
dense_sm6 = Dense(40, activation='relu')(dense_sm5)
dense_sm7 = Dense(30, activation='relu')(dense_sm6)
dense_sm8 = Dropout(0.2)(dense_sm7)
dense_sm9 = Dense(20, activation='relu')(dense_sm8)
output_sm = Dense(1)(dense_sm9)

# 아모레퍼시픽
input_am = Input(shape=(5, 5))
dense_am1 = LSTM(20, return_sequences=True,activation='relu')(input_am)
dense_am2 = Dropout(0.2)(dense_am1)
dense_am3 = LSTM(20, activation='relu')(dense_am2)
dense_am4 = Dense(25, activation='relu')(dense_am3)
dense_am5 = Dropout(0.2)(dense_am4)
dense_am6 = Dense(28, activation='relu')(dense_am5)
dense_am7 = Dense(30, activation='relu')(dense_am6)
...
merge2 = Dense(34, activation='relu')(merge1)
merge3 = Dense(28, activation='relu')(merge2)
merge4 = Dense(34, activation='relu')(merge3)
...
model.fit([samsung_x_train, amore_x_train], samsung_y_train , epochs=1024, batch_size=128, validation_split=0.2, callbacks=[es]) 
