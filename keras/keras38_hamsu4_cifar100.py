...
from tensorflow.keras.layers import Conv2D, Dense, Flatten, Dropout, MaxPooling2D, BatchNormalization,Input
...
#2) ★★★ dnn 모델로 전환하기 위한 data reshape ★★★      /// dnn모델 2차원 이상 가능함. 꼭 reshape해줄 필요 x
x_train=x_train.reshape(50000,32*32*3) # (aa,bb)
x_test=x_test.reshape(10000,32*32*3) # (aa,bb)
# x_train=x_train/255.
# x_test=x_test/255.
