...
from tensorflow.keras.layers import Dense, Input, Dropout, Conv2D, MaxPooling2D, Flatten, LSTM
...
#2.3 model (LSTM)
model=Sequential()
model.add(LSTM(units=15,input_shape=(54,1), activation='relu',return_sequences=True))
model.add(LSTM(15))
