#LSTM 시간 없을 때 사용. conv1d 매우 빠름.


import numpy as np
from tensorflow.keras.layers import LSTM, Dense, SimpleRNN, Bidirectional, GRU, Conv1D
...
model.add(Conv1D(100,kernel_size=2, input_shape=(4,1)))
