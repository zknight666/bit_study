...
#2. model
model=Sequential()
model.add(LSTM(units=40,input_shape=(13,1), activation='relu',return_sequences=True))
model.add(LSTM(20))
...
LSTM 사용했을 때
loss:  [3.7854230403900146, 33.278526306152344]
RMSE :  5.7687544068870125
r2:  0.6606966079742875
