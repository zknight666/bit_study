...
from tensorflow.keras.layers import Dense, Input, Conv2D, MaxPooling2D, Flatten, Dropout,LSTM
import time
import datetime
...
#2. CNN 모델
model=Sequential()
model.add(LSTM(units=15,input_shape=(8,1), activation='relu',return_sequences=True))
model.add(LSTM(15))
