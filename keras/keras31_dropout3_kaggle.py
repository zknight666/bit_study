...
dense3=Dense(50,activation='relu')(dropout1)
...
sampleSubmission_csv.to_csv(path + 'submission_01.12_01.csv')
...
minmax scaler + dropout 사용했을 때
r2 :  0.3607728430889209
RMSE :  143.15853832331598
loss :  [20494.3671875, 104.53987121582031]
