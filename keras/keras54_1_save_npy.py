...
# np.save('C:/study/_data/brain/brain_xy_train.npy',arr=xy_train[0])
...
# print(xy_train[0][1]) # binary로 했을 때 [1. 0. 0. 0. 0. 1. 1. 0. 0. 1.] /    class_mode='categorical'로 했을 때  -> onehot 됨 -> onehot 변환 시간 + onehot 후 용량 ↑
#-> 양 많아지면 변환 시간 많아짐 -> 모델 돌릴때마다 변환하면 시간 낭비 -> numpy로 저장한 후 모델 돌림 -> 원본 data 그래도 바꾸는게 안전
"""
[[0. 1.]
 [0. 1.]
 [1. 0.]
