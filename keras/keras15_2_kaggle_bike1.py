...
# (특정 data일때 bike 사용률 plot 사용하기 그래서 plot이 안된거였네, x,y가 같은 값을 가져야되니)

"""
temp_column=train_csv['temp']
import matplotlib.pyplot as plt
plt.scatter(x,y)
plt.plot(temp_column,y_predict, color='red')
plt.show()
...
sampleSubmission_csv.to_csv(path + 'submission_0106_03.csv')
